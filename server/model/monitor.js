...
class Monitor extends BeanModel {
    ...
    toJSON(preloadData = {}, includeSensitiveData = true) {
        ...
        let data = {
            ...
            system_service_check_method: this.system_service_check_method,
            system_service_ssh_url: this.system_service_ssh_url,
            system_service_ssh_platform: this.system_service_ssh_platform,
